            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <form method="post" action="log.php" class="form-login">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-2 text-right-lg">
                                    <a class="forgot-password" href="#">forgot password?</a>
                                </div>
                                <div class="col-md-6">
                                     <input class="btn btn-theme btn-block btn-theme-dark" type="submit" name="Login" value="Login">
                                </div>
                            </div>
                        </form>
                    </div>
